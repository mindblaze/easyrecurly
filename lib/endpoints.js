...
exports.invoices = {
  ...
  refund: ['/v2/invoices/:invoice_number/refund', 'POST'],
  offline: ['/v2/invoices/invoice_number/transactions', 'POST']
};
...
exports.plans = {
  ...
  delete: ['/v2/plans/:plan_code', 'DELETE']
};
...
exports.subscriptions = {
  ...
  previewChange: ['/v2/subscriptions/:uuid/preview', 'POST'],
